...
class P2 {
  ...
  let src = [
    "images/witch/witch0.gif",
    "images/witch/witch1.gif",
    "images/witch/witch2.gif",
    "images/witch/witch3.gif",
    "images/witch/witch4.gif",
    "images/witch/witch5.gif",
    "images/witch/witch6.gif",
    "images/witch/witch7.gif",
  ];

  //GameOver時の画像
  let lose = new Image();
  lose.src = "images/witch/GameOverWitch1.gif";
  let lose2 = new Image();
  lose2.src = "images/witch/GameOverWitch2.gif";
